...
import { Layout, Loader2, Mail, Lock, ArrowRight, UserPlus } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#030303]">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <p className="text-white/40">Join TEKTILE and start building with AI agents</p>
        </div>
        ...
        <div className="glass-dark p-8 rounded-3xl border border-white/10 shadow-2xl space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#0c0c0c] px-4 text-white/20 font-medium">Or create manually</span></div>
          </div>
